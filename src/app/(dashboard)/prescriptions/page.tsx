...
export default async function PrescriptionsPage() {
  ...
  const data = prescriptions.map((p) => ({
    ...
    odDistanceSphere: p.odDistanceSphere,
    odDistanceCylinder: p.odDistanceCylinder,
    odDistanceAxis: p.odDistanceAxis,
    ...
    odPd: p.odPd,
    osDistanceSphere: p.osDistanceSphere,
    osDistanceCylinder: p.osDistanceCylinder,
    osDistanceAxis: p.osDistanceAxis,
