...
async function main() {
  ...
  console.log('✅ Customer created:', customer.customerNo);
  ...
  console.log('✅ Prescriptions created: 2');
  ...
  console.log('\n📊 Summary:');
  console.log('  - Customer: Nasir Qureshi (CUST00001)');
  console.log('  - Products: 3 items');
  console.log('  - Prescriptions: 2 records');
  console.log('  - Sales: 1 invoice (INV00001)');
  console.log('  - Total: Rs. 5,308.82');
}
